...
const (
	...
	CTRTDTJoinSession                      = 0x98
	CTRTDTListLiveSessions                 = 0x99
	CTRTDTListSessions                     = 0x9a
	CTRTDTGetSession                       = 0x9b
	CTRTDTSwitchHotAudio                   = 0x9c
	CTRTDTCreateSession                    = 0x9d
	CTRTDTInviteToSession                  = 0x9e
	CTRTDTAcceptInvite                     = 0x9f
	...
	CTRTDTRotateCookies                    = 0xa8
	CTRTDTDissolveSession                  = 0xa9
